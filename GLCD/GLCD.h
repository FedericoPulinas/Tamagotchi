...
#define Grigio_medio	 RGB565CONVERT(128, 128, 128)
#define Marroncino		 RGB565CONVERT(224, 161, 117)
#define Pink					 RGB565CONVERT(230, 196, 197)
#define DarkRed 			 RGB565CONVERT(181, 14, 14)
#define DarkBlue			 RGB565CONVERT(23, 90, 209)
...
/*my functions*/
void MyDrawRectangleLine(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t x3, uint16_t y3, uint16_t x4, uint16_t y4, uint16_t Rcolor, uint16_t Lcolor);
void DrawBox(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t x3, uint16_t y3, uint16_t x4, uint16_t y4, uint16_t color);
...
void LCD_Color(uint16_t Color, uint16_t x_min, uint16_t x_max, uint16_t y);
void LCD_Square(uint16_t x, uint16_t y, uint16_t dim, uint16_t Color);
